    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}\small
                ...
                \item Fréchet $\Rightarrow$ fórmula fechada análoga à equação de Eaton-Kortum.
...
\begin{frame}{Equilíbrio de salários e aluguéis}
    \textbf{Salários -- equilíbrio no mercado de bens (Eq.~6):}
    ...
    \normalsize\textbf{Aluguéis -- equilíbrio no mercado de habitação (Eq.~8):}
